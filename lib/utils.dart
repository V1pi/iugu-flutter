...
String getBrandByCreditCardNumber(String number) {
...
var cards = [
  new PatternCreditCard("elo", r"^[0-9]{3}$", r"^(4011(78|79)|43(1274|8935)|45(1416|7393|763(1|2))|50(4175|6699|67[0-7][0-9]|9000)|50(9[0-9][0-9][0-9])|627780|63(6297|6368)|650(03([^4])|04([0-9])|05(0|1)|05([7-9])|06([0-9])|07([0-9])|08([0-9])|4([0-3][0-9]|8[5-9]|9[0-9])|5([0-9][0-9]|3[0-8])|9([0-6][0-9]|7[0-8])|7([0-2][0-9])|541|700|720|727|901)|65165([2-9])|6516([6-7][0-9])|65500([0-9])|6550([0-5][0-9])|655021|65505([6-7])|6516([8-9][0-9])|65170([0-4]))"),
  new PatternCreditCard("visa", r"^[0-9]{3}$", r"^4"),
  new PatternCreditCard("mastercard", r"^[0-9]{3}$", r"^(5[1-5]|677189|222[1-9]|22[3-9]|2[3-6]|27[01]|2720)"),
  new PatternCreditCard("amex", r"^[0-9]{4}$", r"^(34|37)"),
  new PatternCreditCard("diners", r"^[0-9]{3}$", r"^(30|36|38|39)")
];